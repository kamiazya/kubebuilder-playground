...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GuestbookState) DeepCopyInto(out *GuestbookState) {
	*out = *in
	if in.Standby != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GuestbookState.
func (in *GuestbookState) DeepCopy() *GuestbookState {
	if in == nil {
		return nil
	}
	out := new(GuestbookState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GuestbookStatus) DeepCopyInto(out *GuestbookStatus) {
	*out = *in
	in.GuestbookStatus.DeepCopyInto(&out.GuestbookStatus)
	if in.Nodes != nil {
